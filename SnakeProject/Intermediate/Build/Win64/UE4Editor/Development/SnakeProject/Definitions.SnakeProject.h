...
#define UE_PROJECT_NAME SnakeProject
#define UE_TARGET_NAME SnakeProjectEditor
#define UE_MODULE_NAME "SnakeProject"
...
#define SNAKEPROJECT_API DLLEXPORT
